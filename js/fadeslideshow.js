...
var fadeSlideShow_descpanel={
	...
	fontStyle: 'normal 14px Helvetica', //font style for text descriptions
...
function fadeSlideShow(settingarg){
	...
	setting.closebutton=(setting.descreveal=="always")? '<img class="close" src="'+closebutt[0]+'" style="float:right;cursor:hand;cursor:pointer;width:'+closebutt[1]+'px;height:'+closebutt[2]+'px;margin-left: 15px" title="Hide Description" />' : ''
	var slideshow=this
...
fadeSlideShow.routines={
	...
	adddescpanel:function($, setting){
		...
		$('<div class="descpanelbg"></div><div class="descpanelfg"></div>') //create inner nav panel DIVs
			...
			.eq(1).css({color:'white', left:15, width:'100%'}).html(setting.closebutton + setting.longestdesc).end() //"descpanelfg" div
